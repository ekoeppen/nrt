...
#define __NSANDDDKINCLUDES__

class TSendSystemEvent;	// bug in SystemEvents.h

#include "UserGlobals_m.h"
#include "UserTasks_m.h"
#include "Objects_m.h"
...
// The NewtonErrors define kNoMemory once again.
#undef kNoMemory
#include <NewtonErrors.h>

#ifndef WITH_LOCKED_BINARY
