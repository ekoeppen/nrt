...
TTimerElement::TTimerElement(TTimerQueue* q, ULong refCon) {
    /*
        ...
        255684:	e580100c 	str	r1, [r0, #12]	; fLastCalibrate
        255688:	e5c01014 	strb	r1, [r0, #20]	; fField20
        25568c:	e5801008 	str	r1, [r0, #8]	; fHead
        255690:	e5804010 	str	r4, [r0, #16]	; fTimeoutInProgress
 ...
 * Address: 00255894
 */
Boolean	TTimerElement::Prime(TTimeout delta) {
    /*
        ...
        2558a8:	e5900004 	ldr	r0, [r0, #4]	; TTimerElement
        ...
        2558cc:	e584500c 	str	r5, [r4, #12]	; fLastCalibrate
        2558d0:	e5940004 	ldr	r0, [r4, #4]	; TTimerElement
        2558d4:	eb655b4c 	bl	1bac60c <TTimerQueue::$Calibrate(void)>
        2558d8:	e5940004 	ldr	r0, [r4, #4]	; TTimerElement
...
Boolean	TTimerElement::Cancel(void) {
    /*
        ...
        255904:	15910004 	ldrne	r0, [r1, #4]	; TTimerElement
