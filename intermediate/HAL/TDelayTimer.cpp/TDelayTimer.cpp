#include "include/TDelayTimer.h"

/**
 * Symbol: TDelayTimer::__ct(void)
 * Address: 0008e978
 */
TDelayTimer::TDelayTimer(void) {
    /*
         ...
         8e99c:	e59f1004 	ldr	r1, [pc, #4]	; 8e9a8 <TDelayTimer::__ct(void)+0x30>	; fField4
         8e9a0:	e5801008 	str	r1, [r0, #8]	; fField8
 ...
 * Address: 0008e9ac
 */
TDelayTimer::ConvertToHardwareTime(unsigned long) {
    /*
 ...
 * Address: 0008e9b4
 */
TDelayTimer::ConvertFromHardwareTime(unsigned long) {
    /*
 ...
 * Address: 0008e9bc
 */
TDelayTimer::GetHardwareTime(void) {
    /*
         8e9bc:	e5900008 	ldr	r0, [r0, #8]	; fField8
 ...
 * Address: 0008e9c8
 */
TDelayTimer::ShortTimerDelay(unsigned long) {
    /*
         8e9c8:	e5900008 	ldr	r0, [r0, #8]	; fField8
 ...
 * Address: 0008e9f4
 */
TDelayTimer::ResetTimeOut(unsigned long) {
    /*
         8e9f4:	e5902008 	ldr	r2, [r0, #8]	; fField8
         8e9f8:	e5922000 	ldr	r2, [r2]
         8e9fc:	e5801004 	str	r1, [r0, #4]	; fField4
 ...
 * Address: 0008ea08
 */
TDelayTimer::ShortTimerDelayUntil(unsigned long) {
    /*
         8ea08:	e5902008 	ldr	r2, [r0, #8]	; fField8
 ...
 * Address: 0008ea34
 */
TDelayTimer::TimedOut(void) {
    /*
         8ea34:	e5901008 	ldr	r1, [r0, #8]	; fField8
         8ea38:	e5911000 	ldr	r1, [r1]
         8ea3c:	e5902000 	ldr	r2, [r0]
         8ea40:	e0411002 	sub	r1, r1, r2
         8ea44:	e5900004 	ldr	r0, [r0, #4]	; fField4
 ...
 * Address: 0008ea58
 */
TDelayTimer::TimedOut(unsigned long) {
    /*
         8ea58:	e5902008 	ldr	r2, [r0, #8]	; fField8
