#include "DDKIncludes/UtilityClasses/TimerQueue.h"

/**
 * Symbol: TTimerQueue::Cancel(unsigned long)
 * Address: 002556d8
 */
TTimerElement*		TTimerQueue::Cancel(ULong refCon) {
    /*
        ...
        255714:	e5921008 	ldr	r1, [r2, #8]	; fQueue
        255718:	e3310000 	teq	r1, #0	; 0x0
        25571c:	0a000003 	beq	255730 <TTimerQueue::Cancel(unsigned long)+0x58>
        255720:	e592e00c 	ldr	lr, [r2, #12]	; fNext
        255724:	e5b1c00c 	ldr	ip, [r1, #12]!	; fNext
        255728:	e08ec00c 	add	ip, lr, ip
        25572c:	e581c000 	str	ip, [r1]
        255730:	e3330000 	teq	r3, #0	; 0x0
        255734:	05921008 	ldreq	r1, [r2, #8]	; fQueue
        255738:	05801000 	streq	r1, [r0]
        25573c:	15920008 	ldrne	r0, [r2, #8]	; fQueue
        255740:	15a30008 	strne	r0, [r3, #8]!	; fQueue
        255744:	e3a00000 	mov	r0, #0	; 0x0
        255748:	e5820008 	str	r0, [r2, #8]	; fQueue
        25574c:	e5c20014 	strb	r0, [r2, #20]	; fRefCon
...
TTimerQueue::TTimerQueue() {
    /*
        ...
        255950:	e5c4500c 	strb	r5, [r4, #12]	; fNext
...
TTimeout			TTimerQueue::Check(void) {
    /*
        ...
        2559e0:	e5c4000c 	strb	r0, [r4, #12]	; fNext
        2559e4:	e5940000 	ldr	r0, [r4]
        2559e8:	e3300000 	teq	r0, #0	; 0x0
        2559ec:	15b0600c 	ldrne	r6, [r0, #12]!	; fNext
...
TTimerQueue::Calibrate(void) {
    /*
        ...
        255a08:	e5d0000c 	ldrb	r0, [r0, #12]	; fNext
        ...
        255a58:	e59d0004 	ldr	r0, [sp, #4]	; TTimerQueue
...
TTimerQueue::Enqueue(TTimerElement *) {
    /*
        ...
        255af4:	e591e00c 	ldr	lr, [r1, #12]	; fNext
        255af8:	e592c00c 	ldr	ip, [r2, #12]	; fNext
        ...
        255b10:	e581300c 	str	r3, [r1, #12]	; fNext
        255b14:	e1a03002 	mov	r3, r2
        255b18:	e5922008 	ldr	r2, [r2, #8]	; fQueue
...
TTimerQueue::Dequeue(TTimerElement *, unsigned char) {
    /*
        ...
        255b7c:	e5913004 	ldr	r3, [r1, #4]	; TTimerQueue
        ...
        255ba4:	e5922008 	ldr	r2, [r2, #8]	; fQueue
        ...
        255bc0:	15921008 	ldrne	r1, [r2, #8]	; fQueue
        255bc4:	13310000 	teqne	r1, #0	; 0x0
        255bc8:	0a000003 	beq	255bdc <TTimerQueue::Dequeue(TTimerElement *, unsigned char)+0x74>
        255bcc:	e592e00c 	ldr	lr, [r2, #12]	; fNext
        255bd0:	e5b1c00c 	ldr	ip, [r1, #12]!	; fNext
        255bd4:	e08ec00c 	add	ip, lr, ip
        255bd8:	e581c000 	str	ip, [r1]
        255bdc:	e3330000 	teq	r3, #0	; 0x0
        255be0:	05921008 	ldreq	r1, [r2, #8]	; fQueue
        255be4:	05801000 	streq	r1, [r0]
        255be8:	15920008 	ldrne	r0, [r2, #8]	; fQueue
        255bec:	15a30008 	strne	r0, [r3, #8]!	; fQueue
        255bf0:	e3a00000 	mov	r0, #0	; 0x0
        255bf4:	e5820008 	str	r0, [r2, #8]	; fQueue
        255bf8:	e5c20014 	strb	r0, [r2, #20]	; fRefCon
